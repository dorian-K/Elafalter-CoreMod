declare class Minecraft {
	...
	/** _tryCatchupMovementTicks(void): void */
	_tryCatchupMovementTicks(): void; /// ?_tryCatchupMovementTicks@Minecraft@@AEAAXXZ
	...
	/** init(void): void */
	init(): void; /// ?init@Minecraft@@QEAAXXZ
...
declare class ActorDefinitionIdentifier {
	...
	ActorDefinitionIdentifier(_1: object): ActorDefinitionIdentifier; /// ??0ActorDefinitionIdentifier@@QEAA@PEBD@Z
...
declare class AABB {
	...
	/** set(Vec3 const &,Vec3 const &): class AABB & __ptr64 */
	set(_1: object, _2: object): AABB; /// ?set@AABB@@QEAAAEAV1@AEBVVec3@@0@Z
...
declare class StateVectorComponent {
	// Attributes 
	pos: Vec3;
	oldPos: Vec3;
	velocity: Vec3;
	// Methods 
	// Inherited from StateVectorComponent
}
declare class Abilities {
	...
	/** Abilities(bool) */
	Abilities(_1: boolean): Abilities; /// ??0Abilities@@QEAA@_N@Z
...
declare class AABBShapeComponent {
	// Attributes 
	lower: Vec3;
	width: number;
	height: number;
	upper: Vec3;
	// Methods 
	// Inherited from AABBShapeComponent
	/** toString(void): class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> > */
	toString(): unknown; /// ?toString@AABBShapeComponent@@QEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ
	// Inherited from AABB
	/** clipCollide(AABB const &,Vec3 const &,bool,float *): class Vec3 */
	clipCollide(_1: object, _2: object, _3: boolean, _4: object): unknown; /// ?clipCollide@AABB@@QEBA?AVVec3@@AEBV1@AEBV2@_NPEAM@Z
	/** cloneAndExpandAlongDirection(Vec3 const &): class AABB */
...
declare class Actor {
	...
	/** _damageNearbyMobs(void): void */
	_damageNearbyMobs(): void; /// ?_damageNearbyMobs@Actor@@AEAAXXZ
	/** _defaultInitEquipmentDropChances(void): void */
	_defaultInitEquipmentDropChances(): void; /// ?_defaultInitEquipmentDropChances@Actor@@AEAAXXZ
	...
	/** _isHeadInWater(void): bool */
	_isHeadInWater(): boolean; /// ?_isHeadInWater@Actor@@IEBA_NXZ
	...
	/** _refreshAABB(void): void */
	_refreshAABB(): void; /// ?_refreshAABB@Actor@@IEAAXXZ
	...
	/** _spawnPukeParticles(void): void */
	_spawnPukeParticles(): void; /// ?_spawnPukeParticles@Actor@@AEAAXXZ
	...
	/** applySnapshot(EntityContext const &,EntityContext const &): void */
	applySnapshot(_1: object, _2: object): void; /// ?applySnapshot@Actor@@UEAAXAEBVEntityContext@@0@Z
	...
	/** canBeAffected(uint): bool */
	canBeAffected(_1: bigint): boolean; /// ?canBeAffected@Actor@@UEBA_NI@Z
	...
	/** canFly(void): bool */
	canFly(): boolean; /// ?canFly@Actor@@QEBA_NXZ
	/** canMate(Actor const &): bool */
	canMate(_1: object): boolean; /// ?canMate@Actor@@QEBA_NAEBV1@@Z
	...
	/** dropLeash(bool,bool): void */
	dropLeash(_1: boolean, _2: boolean): void; /// ?dropLeash@Actor@@QEAAX_N0@Z
	...
	/** getCategories(void): enum ActorCategory */
	getCategories(): bigint; /// ?getCategories@Actor@@QEBA?AW4ActorCategory@@XZ
	...
	/** getEntityData(void): class SynchedActorDataEntityWrapper const & __ptr64 */
	getEntityData(): SynchedActorDataEntityWrapper; /// ?getEntityData@Actor@@QEBAAEBVSynchedActorDataEntityWrapper@@XZ
	...
	/** getLeashHolder(void): struct ActorUniqueID */
	getLeashHolder(): unknown; /// ?getLeashHolder@Actor@@QEBA?AUActorUniqueID@@XZ
	...
	/** getRadius(void): float */
	getRadius(): number; /// ?getRadius@Actor@@QEBAMXZ
	...
	/** getStrengthMax(void): int */
	getStrengthMax(): number; /// ?getStrengthMax@Actor@@QEBAHXZ
	...
	/** hasBeenHurtByMobInLastTicks(int): bool */
	hasBeenHurtByMobInLastTicks(_1: number): boolean; /// ?hasBeenHurtByMobInLastTicks@Actor@@QEBA_NH@Z
	...
	/** initParams(RenderParams &): void */
	initParams(_1: object): void; /// ?initParams@Actor@@QEAAXAEAVRenderParams@@@Z
	...
	/** isIgnited(void): bool */
	isIgnited(): boolean; /// ?isIgnited@Actor@@QEBA_NXZ
	...
	/** isInClouds(void): bool */
	isInClouds(): boolean; /// ?isInClouds@Actor@@QEBA_NXZ
	/** isInLava(void): bool */
	...
	/** isInScaffolding(void): bool */
	isInScaffolding(): boolean; /// ?isInScaffolding@Actor@@QEBA_NXZ
	/** isInSnow(void): bool */
	...
	/** isMovedToLimbo(void): bool */
	isMovedToLimbo(): boolean; /// ?isMovedToLimbo@Actor@@QEBA_NXZ
	/** isMoving(void): bool */
	isMoving(): boolean; /// ?isMoving@Actor@@QEBA_NXZ
	/** isOnFire(void): bool */
	isOnFire(): boolean; /// ?isOnFire@Actor@@UEBA_NXZ
	/** isOnHotBlock(void): bool */
	isOnHotBlock(): boolean; /// ?isOnHotBlock@Actor@@UEBA_NXZ
	/** isOverWater(void): bool */
	isOverWater(): boolean; /// ?isOverWater@Actor@@UEBA_NXZ
	/** isPacified(void): bool */
	isPacified(): boolean; /// ?isPacified@Actor@@QEBA_NXZ
	/** isPassenger(Actor const &): bool */
	isPassenger(_1: object): boolean; /// ?isPassenger@Actor@@QEBA_NAEBV1@@Z
	/** isPersistent(void): bool */
	isPersistent(): boolean; /// ?isPersistent@Actor@@QEBA_NXZ
	...
	/** isResting(void): bool */
	isResting(): boolean; /// ?isResting@Actor@@QEBA_NXZ
	/** isRiding(Actor *): bool */
	...
	/** isSwimmer(void): bool */
	isSwimmer(): boolean; /// ?isSwimmer@Actor@@QEBA_NXZ
	/** isTame(void): bool */
	...
	/** lerpTo(Vec3 const &,Vec2 const &,int): void */
	lerpTo(_1: object, _2: object, _3: number): void; /// ?lerpTo@Actor@@QEAAXAEBVVec3@@AEBVVec2@@H@Z
	...
	/** onOnewayCollision(AABB const &): void */
	onOnewayCollision(_1: object): void; /// ?onOnewayCollision@Actor@@QEAAXAEBVAABB@@@Z
	/** onOrphan(void): void */
	...
	/** playSound(LevelSoundEvent,Vec3 const &,Block const &): void */
	playSound(_1: unknown, _2: object, _3: object): void; /// ?playSound@Actor@@QEAAXW4LevelSoundEvent@@AEBVVec3@@AEBVBlock@@@Z
	...
	/** queueBBUpdateFromValue(Vec2 const &): void */
	queueBBUpdateFromValue(_1: object): void; /// ?queueBBUpdateFromValue@Actor@@QEAAXAEBVVec2@@@Z
	...
	/** refreshComponents(void): void */
	refreshComponents(): void; /// ?refreshComponents@Actor@@QEAAXXZ
	/** reload(void): void */
	...
	/** sendMotionToServer(void): void */
	sendMotionToServer(): void; /// ?sendMotionToServer@Actor@@QEAAXXZ
	...
	/** setBaseDefinition(ActorDefinitionIdentifier const &,bool,bool): void */
	setBaseDefinition(_1: object, _2: boolean, _3: boolean): void; /// ?setBaseDefinition@Actor@@QEAAXAEBUActorDefinitionIdentifier@@_N1@Z
	...
	/** setBlockTarget(BlockPos const &): void */
	setBlockTarget(_1: object): void; /// ?setBlockTarget@Actor@@QEAAXAEBVBlockPos@@@Z
	...
	/** setMovedToUnloadedChunk(bool): void */
	setMovedToUnloadedChunk(_1: boolean): void; /// ?setMovedToUnloadedChunk@Actor@@QEAAX_N@Z
	...
	/** spawnEatParticles(ItemStack const &,int): void */
	spawnEatParticles(_1: object, _2: number): void; /// ?spawnEatParticles@Actor@@QEAAXAEBVItemStack@@H@Z
	...
	/** transferTickingArea(Dimension &): void */
	transferTickingArea(_1: object): void; /// ?transferTickingArea@Actor@@QEAAXAEAVDimension@@@Z
...
declare class GameRules {
	...
	getTagData(_1: object): void; /// ?getTagData@GameRules@@QEAAXAEBVCompoundTag@@@Z
...
declare class ActorEventPacket {
	...
	/** writeWithHeader(SubClientId,BinaryStream &): void */
	writeWithHeader(_1: unknown, _2: object): void; /// ?writeWithHeader@Packet@@QEBAXW4SubClientId@@AEAVBinaryStream@@@Z
}
...
declare class ItemStack {
	...
	ItemStack(_1: object, _2: number, _3: object): ItemStack; /// ??0ItemStack@@QEAA@AEBVBlock@@HPEBVCompoundTag@@@Z
	...
	/** getMaxUseDuration(void): int */
	getMaxUseDuration(): number; /// ?getMaxUseDuration@ItemStack@@QEBAHXZ
	...
	/** canDestroy(Block const *): bool */
	canDestroy(_1: object): boolean; /// ?canDestroy@ItemStackBase@@QEBA_NPEBVBlock@@@Z
	...
	/** isStackable(void): bool */
	isStackable(): boolean; /// ?isStackable@ItemStackBase@@QEBA_NXZ
	/** isStackedByData(void): bool */
	isStackedByData(): boolean; /// ?isStackedByData@ItemStackBase@@QEBA_NXZ
	/** isWearableItem(void): bool */
	isWearableItem(): boolean; /// ?isWearableItem@ItemStackBase@@QEBA_NXZ
	...
	/** refreshedInContainer(Level &): void */
	refreshedInContainer(_1: object): void; /// ?refreshedInContainer@ItemStackBase@@QEBAXAEAVLevel@@@Z
	/** remove(int): void */
...
declare class Block {
	...
	/** asItemInstance(BlockSource &,BlockPos const &): class ItemInstance */
	asItemInstance(_1: object, _2: object): unknown; /// ?asItemInstance@Block@@QEBA?AVItemInstance@@AEAVBlockSource@@AEBVBlockPos@@@Z
	...
	/** buildDescriptionId(void): class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> > */
	buildDescriptionId(): unknown; /// ?buildDescriptionId@Block@@QEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ
	...
	/** canBeBuiltOver(BlockSource &,BlockPos const &,BlockItem const &): bool */
	canBeBuiltOver(_1: object, _2: object, _3: object): boolean; /// ?canBeBuiltOver@Block@@QEBA_NAEAVBlockSource@@AEBVBlockPos@@AEBVBlockItem@@@Z
	...
	/** getConnectedDirections(BlockPos const &,BlockSource &,bool &,bool &,bool &,bool &): void */
	getConnectedDirections(_1: object, _2: object, _3: object, _4: object, _5: object, _6: object): void; /// ?getConnectedDirections@Block@@QEBAXAEBVBlockPos@@AEAVBlockSource@@AEA_N222@Z
	...
	/** getLight(void): struct Brightness */
	getLight(): unknown; /// ?getLight@Block@@QEBA?AUBrightness@@XZ
	...
	/** hasBlockEntity(void): bool */
	hasBlockEntity(): boolean; /// ?hasBlockEntity@Block@@QEBA_NXZ
	/** hasProperty(BlockProperty): bool */
	hasProperty(_1: unknown): boolean; /// ?hasProperty@Block@@QEBA_NW4BlockProperty@@@Z
	/** hasPropertyNoLock(BlockProperty): bool */
	hasPropertyNoLock(_1: unknown): boolean; /// ?hasPropertyNoLock@Block@@QEBA_NW4BlockProperty@@@Z
	...
	/** isClimbable(IActorMovementProxy const &): bool */
	isClimbable(_1: object): boolean; /// ?isClimbable@Block@@QEBA_NAEBUIActorMovementProxy@@@Z
	/** isCropBlock(void): bool */
	isCropBlock(): boolean; /// ?isCropBlock@Block@@QEBA_NXZ
	...
	/** isFilteredOut(BlockRenderLayer): bool */
	isFilteredOut(_1: unknown): boolean; /// ?isFilteredOut@Block@@QEBA_NW4BlockRenderLayer@@@Z
	/** isInteractiveBlock(void): bool */
	isInteractiveBlock(): boolean; /// ?isInteractiveBlock@Block@@QEBA_NXZ
	/** isMotionBlockingBlock(void): bool */
	isMotionBlockingBlock(): boolean; /// ?isMotionBlockingBlock@Block@@QEBA_NXZ
	/** isMultifaceBlock(void): bool */
	isMultifaceBlock(): boolean; /// ?isMultifaceBlock@Block@@QEBA_NXZ
	...
	/** movedByPiston(BlockSource &,BlockPos const &): void */
	movedByPiston(_1: object, _2: object): void; /// ?movedByPiston@Block@@QEBAXAEAVBlockSource@@AEBVBlockPos@@@Z
	...
	/** onStructureBlockPlace(BlockSource &,BlockPos const &): void */
	onStructureBlockPlace(_1: object, _2: object): void; /// ?onStructureBlockPlace@Block@@QEBAXAEAVBlockSource@@AEBVBlockPos@@@Z
	...
	/** tryGetInfested(void): class Block const * __ptr64 */
	tryGetInfested(): Block; /// ?tryGetInfested@Block@@QEBAPEBV1@XZ
...
declare class InventoryTransaction {
	...
	/** serialize(BinaryStream &,bool): void */
	serialize(_1: object, _2: boolean): void; /// ?serialize@InventoryTransaction@@QEBAXAEAVBinaryStream@@_N@Z
...
declare class BlockSource {
	...
	/** _addToTickingQueue(BlockPos const &,Block const &,int,int,TickingQueueType,bool): void */
	_addToTickingQueue(_1: object, _2: object, _3: number, _4: number, _5: unknown, _6: boolean): void; /// ?_addToTickingQueue@BlockSource@@AEAAXAEBVBlockPos@@AEBVBlock@@HHW4TickingQueueType@@_N@Z
	...
	/** addToRandomTickingQueue(BlockPos const &,Block const &,int,int,bool): void */
	addToRandomTickingQueue(_1: object, _2: object, _3: number, _4: number, _5: boolean): void; /// ?addToRandomTickingQueue@BlockSource@@QEAAXAEBVBlockPos@@AEBVBlock@@HH_N@Z
	...
	/** areChunksFullyLoaded(BlockPos const &,BlockPos const &): bool */
	areChunksFullyLoaded(_1: object, _2: object): boolean; /// ?areChunksFullyLoaded@BlockSource@@QEBA_NAEBVBlockPos@@0@Z
	...
	/** checkBlockPermissions(Actor &,BlockPos const &,uchar,ItemStackBase const &,bool): bool */
	checkBlockPermissions(_1: object, _2: object, _3: number, _4: object, _5: boolean): boolean; /// ?checkBlockPermissions@BlockSource@@QEAA_NAEAVActor@@AEBVBlockPos@@EAEBVItemStackBase@@_N@Z
	...
	/** fetchBlockEntities(AABB const &): class std::vector<class BlockActor * __ptr64,class std::allocator<class BlockActor * __ptr64> > const & __ptr64 */
	fetchBlockEntities(_1: object): unknown; /// ?fetchBlockEntities@BlockSource@@QEAAAEBV?$vector@PEAVBlockActor@@V?$allocator@PEAVBlockActor@@@std@@@std@@AEBVAABB@@@Z
	...
	/** findNextTopSolidBlockAbove(BlockPos &): bool */
	findNextTopSolidBlockAbove(_1: object): boolean; /// ?findNextTopSolidBlockAbove@BlockSource@@QEAA_NAEAVBlockPos@@@Z
	...
	/** getMaxHeight(void): short */
	getMaxHeight(): number; /// ?getMaxHeight@BlockSource@@UEBAFXZ
	...
	/** getTickingQueue(BlockPos const &,TickingQueueType,bool): class BlockTickingQueue * __ptr64 */
	getTickingQueue(_1: object, _2: unknown, _3: boolean): unknown; /// ?getTickingQueue@BlockSource@@QEBAPEAVBlockTickingQueue@@AEBVBlockPos@@W4TickingQueueType@@_N@Z
	...
	/** hasTickInPendingTicks(BlockPos const &,BlockLegacy const &): bool */
	hasTickInPendingTicks(_1: object, _2: object): boolean; /// ?hasTickInPendingTicks@BlockSource@@QEBA_NAEBVBlockPos@@AEBVBlockLegacy@@@Z
	/** isChunkFullyLoaded(ChunkPos const &,ChunkSource const &): bool */
	isChunkFullyLoaded(_1: object, _2: object): boolean; /// ?isChunkFullyLoaded@BlockSource@@QEBA_NAEBVChunkPos@@AEBVChunkSource@@@Z
	...
	/** isInstaticking(BlockPos const &): bool */
	isInstaticking(_1: object): boolean; /// ?isInstaticking@BlockSource@@QEBA_NAEBVBlockPos@@@Z
	...
	/** isUnobstructedByEntities(AABB const &,Actor const *): bool */
	isUnobstructedByEntities(_1: object, _2: object): boolean; /// ?isUnobstructedByEntities@BlockSource@@QEAA_NAEBVAABB@@PEBVActor@@@Z
	/** isWithinHeightLimits(int): bool */
	isWithinHeightLimits(_1: number): boolean; /// ?isWithinHeightLimits@BlockSource@@QEBA_NH@Z
	...
	/** removeFromRandomTickingQueue(BlockPos const &,Block const &): void */
	removeFromRandomTickingQueue(_1: object, _2: object): void; /// ?removeFromRandomTickingQueue@BlockSource@@QEAAXAEBVBlockPos@@AEBVBlock@@@Z
...
declare class FillingContainer {
	...
	/** _addResource(ItemStack const &): int */
	_addResource(_1: object): number; /// ?_addResource@FillingContainer@@IEAAHAEBVItemStack@@@Z
...
declare class MoveInputHandler {
	...
	MoveInputHandler(): MoveInputHandler; /// ??0MoveInputHandler@@IEAA@XZ
...
declare class CompoundTag {
	...
	/** append(CompoundTag const &): void */
	append(_1: object): void; /// ?append@CompoundTag@@QEAAXAEBV1@@Z
	/** clear(void): void */
...
declare class Item {
	...
	/** calculatePlacePos(ItemStackBase &,Actor &,uchar &,BlockPos &): bool */
	calculatePlacePos(_1: object, _2: object, _3: object, _4: object): boolean; /// ?calculatePlacePos@Item@@QEBA_NAEAVItemStackBase@@AEAVActor@@AEAEAEAVBlockPos@@@Z
	...
	/** getCommandNames(void): class std::vector<struct CommandName,class std::allocator<struct CommandName> > */
	getCommandNames(): unknown; /// ?getCommandNames@Item@@QEBA?AV?$vector@UCommandName@@V?$allocator@UCommandName@@@std@@@std@@XZ
	...
	/** getCreativeCategory(void): enum CreativeItemCategory */
	getCreativeCategory(): bigint; /// ?getCreativeCategory@Item@@QEBA?AW4CreativeItemCategory@@XZ
	/** getDamageChance(int): int */
	getDamageChance(_1: number): number; /// ?getDamageChance@Item@@UEBAHH@Z
	/** getFullItemName(void): class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> > const & __ptr64 */
	getFullItemName(): unknown; /// ?getFullItemName@Item@@QEBAAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ
	/** getId(void): short */
	...
	/** setAllowOffhand(bool): class Item & __ptr64 */
	setAllowOffhand(_1: boolean): Item; /// ?setAllowOffhand@Item@@QEAAAEAV1@_N@Z
...
declare class LocalPlayer {
	...
	/** _registerElytraLoopSound(void): void */
	_registerElytraLoopSound(): void; /// ?_registerElytraLoopSound@Player@@AEAAXXZ
	/** _shouldProvideFeedbackOnArmorSet(ArmorSlot,ItemStack const &): bool */
	...
	/** _updateInteraction(void): void */
	_updateInteraction(): void; /// ?_updateInteraction@Player@@IEAAXXZ
	/** _validateSpawnPositionAvailability(Vec3 const &,BlockSource *,Vec3 const * const): bool */
	_validateSpawnPositionAvailability(_1: object, _2: object, _3: object): boolean; /// ?_validateSpawnPositionAvailability@Player@@IEBA_NAEBVVec3@@PEAVBlockSource@@QEBV2@@Z
	/** add(ItemStack &): bool */
	...
	/** canObstructSpawningAndBlockPlacement(void): bool */
	canObstructSpawningAndBlockPlacement(): boolean; /// ?canObstructSpawningAndBlockPlacement@Player@@UEBA_NXZ
	...
	/** getContainerManager(void): class std::weak_ptr<class IContainerManager> */
	getContainerManager(): unknown; /// ?getContainerManager@Player@@QEAA?AV?$weak_ptr@VIContainerManager@@@std@@XZ
	/** getDestroyProgress(Block const &): float */
	getDestroyProgress(_1: object): number; /// ?getDestroyProgress@Player@@QEBAMAEBVBlock@@@Z
	/** getEntityTypeId(void): enum ActorType */
	...
	/** getItemInteractText(Item const &): class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> > */
	getItemInteractText(_1: object): unknown; /// ?getItemInteractText@Player@@QEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBVItem@@@Z
	...
	/** getName(void): class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> > const & __ptr64 */
	getName(): unknown; /// ?getName@Player@@QEBAAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ
	/** getPlayerUIItem(PlayerUISlot): class ItemStack const & __ptr64 */
	getPlayerUIItem(_1: unknown): ItemStack; /// ?getPlayerUIItem@Player@@QEAAAEBVItemStack@@W4PlayerUISlot@@@Z
	...
	/** hasOpenContainerOfContainerType(ContainerType): bool */
	hasOpenContainerOfContainerType(_1: unknown): boolean; /// ?hasOpenContainerOfContainerType@Player@@QEBA_NW4ContainerType@@@Z
	/** hasResource(ItemDescriptor const &): bool */
	hasResource(_1: object): boolean; /// ?hasResource@Player@@QEAA_NAEBVItemDescriptor@@@Z
	...
	/** jumpFromGround(IMobMovementProxy &): void */
	jumpFromGround(_1: object): void; /// ?jumpFromGround@Player@@UEBAXAEAUIMobMovementProxy@@@Z
	...
	/** setPlayerUIItem(PlayerUISlot,ItemStack const &): void */
	setPlayerUIItem(_1: unknown, _2: object): void; /// ?setPlayerUIItem@Player@@QEAAXW4PlayerUISlot@@AEBVItemStack@@@Z
	/** setRespawnPositionCandidate(void): void */
	setRespawnPositionCandidate(): void; /// ?setRespawnPositionCandidate@Player@@QEAAXXZ
	/** setSelectedSlot(int): class ItemStack const & __ptr64 */
	setSelectedSlot(_1: number): ItemStack; /// ?setSelectedSlot@Player@@QEAAAEBVItemStack@@H@Z
	...
	/** updateTrackedBosses(void): void */
	updateTrackedBosses(): void; /// ?updateTrackedBosses@Player@@QEAAXXZ
	/** useItem(ItemStackBase &,ItemUseMethod,bool): void */
	...
	/** canChangeDimensionsUsingPortal(void): bool */
	canChangeDimensionsUsingPortal(): boolean; /// ?canChangeDimensionsUsingPortal@Mob@@UEBA_NXZ
	...
	/** getJumpPower(void): float */
	getJumpPower(): number; /// ?getJumpPower@Mob@@QEBAMXZ
	...
	/** getJumpTicks(void): int */
	getJumpTicks(): number; /// ?getJumpTicks@Mob@@QEBAHXZ
	...
	/** hasBoundOrigin(void): bool */
	hasBoundOrigin(): boolean; /// ?hasBoundOrigin@Mob@@QEBA_NXZ
	...
	/** setPassengerRotLimit(float): void */
	setPassengerRotLimit(_1: number): void; /// ?setPassengerRotLimit@Mob@@QEAAXM@Z
	/** setSpeedModifier(float): void */
	setSpeedModifier(_1: number): void; /// ?setSpeedModifier@Mob@@QEAAXM@Z
	/** setSprinting(BaseAttributeMap &,SynchedActorDataWriter,bool): void */
	setSprinting(_1: object, _2: unknown, _3: boolean): void; /// ?setSprinting@Mob@@SAXAEAVBaseAttributeMap@@VSynchedActorDataWriter@@_N@Z
	...
	/** snapToYHeadRot(float): void */
	snapToYHeadRot(_1: number): void; /// ?snapToYHeadRot@Mob@@QEAAXM@Z
	/** startRiding(Actor &): bool */
	...
	/** tickEffects(void): void */
	tickEffects(): void; /// ?tickEffects@Mob@@IEAAXXZ
	/** updateAi(void): void */
...
declare class InternalItemDescriptor {
	...
	/** deserialize(ReadOnlyBinaryStream &): class std::unique_ptr<struct InternalItemDescriptor,struct std::default_delete<struct InternalItemDescriptor> > */
	deserialize(_1: object): unknown; /// ?deserialize@InternalItemDescriptor@@SA?AV?$unique_ptr@UInternalItemDescriptor@@U?$default_delete@UInternalItemDescriptor@@@std@@@std@@AEAVReadOnlyBinaryStream@@@Z
...
declare class Dimension {
	...
	/** flushLevelChunkGarbageCollector(void): void */
	flushLevelChunkGarbageCollector(): void; /// ?flushLevelChunkGarbageCollector@Dimension@@QEAAXXZ
	...
	/** getFeatureTerrainAdjustments(void): class FeatureTerrainAdjustments & __ptr64 */
	getFeatureTerrainAdjustments(): unknown; /// ?getFeatureTerrainAdjustments@Dimension@@QEAAAEAVFeatureTerrainAdjustments@@XZ
	...
	/** isSubChunkHeightWithinRange(short const &): bool */
	isSubChunkHeightWithinRange(_1: object): boolean; /// ?isSubChunkHeightWithinRange@Dimension@@QEBA_NAEBF@Z
...
declare class LevelData {
	...
	/** getFlatWorldGeneratorOptions(void): class Json::Value const & __ptr64 */
	getFlatWorldGeneratorOptions(): unknown; /// ?getFlatWorldGeneratorOptions@LevelData@@QEBAAEBVValue@Json@@XZ
	/** getForceGameType(void): bool */
	getForceGameType(): boolean; /// ?getForceGameType@LevelData@@QEBA_NXZ
	...
	/** hasBonusChestEnabled(void): bool */
	hasBonusChestEnabled(): boolean; /// ?hasBonusChestEnabled@LevelData@@QEBA_NXZ
	/** hasCommandsEnabled(void): bool */
	hasCommandsEnabled(): boolean; /// ?hasCommandsEnabled@LevelData@@QEBA_NXZ
	/** hasMapsCenteredToOrigin(void): bool */
	hasMapsCenteredToOrigin(): boolean; /// ?hasMapsCenteredToOrigin@LevelData@@QEBA_NXZ
	...
	/** setGenerator(GeneratorType): void */
	setGenerator(_1: unknown): void; /// ?setGenerator@LevelData@@QEAAXW4GeneratorType@@@Z
	/** setLightningTime(int): void */
	setLightningTime(_1: number): void; /// ?setLightningTime@LevelData@@QEAAXH@Z
	/** setRainLevel(float): void */
	setRainLevel(_1: number): void; /// ?setRainLevel@LevelData@@QEAAXM@Z
	...
	/** setTagData(CompoundTag &): void */
	setTagData(_1: object): void; /// ?setTagData@LevelData@@QEBAXAEAVCompoundTag@@@Z
...
declare class HitResult {
	...
	/** HitResult(Vec3 const &,Vec3 const &,BlockPos const &,uchar,Vec3 const &) */
	HitResult(_1: object, _2: object, _3: object, _4: number, _5: object): HitResult; /// ??0HitResult@@QEAA@AEBVVec3@@0AEBVBlockPos@@E0@Z
	...
	/** getEntity(bool): class Actor * __ptr64 */
	getEntity(_1: boolean): Actor; /// ?getEntity@HitResult@@QEAAPEAVActor@@_N@Z
...
declare class ItemDescriptor {
	...
	/** getLegacyBlock(void): class WeakPtr<class BlockLegacy> const & __ptr64 */
	getLegacyBlock(): unknown; /// ?getLegacyBlock@ItemDescriptor@@QEBAAEBV?$WeakPtr@VBlockLegacy@@@@XZ
	/** getRawNameId(void): class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> > */
	getRawNameId(): unknown; /// ?getRawNameId@ItemDescriptor@@QEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ
	/** sameItem(ItemDescriptor const &,bool): bool */
	sameItem(_1: object, _2: boolean): boolean; /// ?sameItem@ItemDescriptor@@QEBA_NAEBV1@_N@Z
	/** sameItem(ItemStack const &,bool): bool */
	sameItem(_1: object, _2: boolean): boolean; /// ?sameItem@ItemDescriptor@@QEBA_NAEBVItemStack@@_N@Z
	/** save(void): class std::optional<class CompoundTag> */
	save(): unknown; /// ?save@ItemDescriptor@@QEBA?AV?$optional@VCompoundTag@@@std@@XZ
	/** serialize(BinaryStream &): void */
...
declare class ItemDescriptorCount {
	...
	/** serialize(BinaryStream &): void */
	serialize(_1: object): void; /// ?serialize@ItemDescriptorCount@@UEBAXAEAVBinaryStream@@@Z
	// Inherited from ItemDescriptor
	/** _resolve(void): void */
	_resolve(): void; /// ?_resolve@ItemDescriptor@@AEBAXXZ
	/** bindType(void): void */
...
declare class LevelSettings {
	...
	/** achievementsWillBeDisabledOnLoad(void): bool */
	achievementsWillBeDisabledOnLoad(): boolean; /// ?achievementsWillBeDisabledOnLoad@LevelSettings@@QEBA_NXZ
	/** educationFeaturesEnabled(void): bool */
	educationFeaturesEnabled(): boolean; /// ?educationFeaturesEnabled@LevelSettings@@QEBA_NXZ
	/** getGenerator(void): enum GeneratorType */
	getGenerator(): bigint; /// ?getGenerator@LevelSettings@@QEBA?AW4GeneratorType@@XZ
	...
	/** setSpawnSettings(SpawnSettings): class LevelSettings & __ptr64 */
	setSpawnSettings(_1: unknown): LevelSettings; /// ?setSpawnSettings@LevelSettings@@QEAAAEAV1@USpawnSettings@@@Z
	...
	/** setUseMsaGamertagsOnly(bool): class LevelSettings & __ptr64 */
	setUseMsaGamertagsOnly(_1: boolean): LevelSettings; /// ?setUseMsaGamertagsOnly@LevelSettings@@QEAAAEAV1@_N@Z
...
/*
declare class Json::Value::Value { 
	// Attributes 
	// Methods 
	// Inherited from Json::Value::Value
}
*/
declare class Level {
	// Attributes 
	...
	/** _checkBlockSourceValidity(void): void */
	_checkBlockSourceValidity(): void; /// ?_checkBlockSourceValidity@Level@@AEAAXXZ
	...
	/** addBreakingItemParticleEffect(Vec3 const &,ParticleType,ResolvedItemIconInfo const &): void */
	addBreakingItemParticleEffect(_1: object, _2: unknown, _3: object): void; /// ?addBreakingItemParticleEffect@Level@@UEAAXAEBVVec3@@W4ParticleType@@AEBUResolvedItemIconInfo@@@Z
	...
	/** applyLiquidPhysicsToActor(Actor *,MaterialType): bool */
	applyLiquidPhysicsToActor(_1: object, _2: unknown): boolean; /// ?applyLiquidPhysicsToActor@Level@@UEAA_NPEAVActor@@W4MaterialType@@@Z
	...
	/** transferActorToOwnedEntityLimbo(Player const &,Actor &): void */
	transferActorToOwnedEntityLimbo(_1: object, _2: object): void; /// ?transferActorToOwnedEntityLimbo@Level@@QEAAXAEBVPlayer@@AEAVActor@@@Z
...
declare class Mob {
	...
	joinCaravan(_1: object): void; /// ?joinCaravan@Mob@@UEAAXPEAV1@@Z
	/** jumpFromGround(IMobMovementProxy &): void */
	jumpFromGround(_1: object): void; /// ?jumpFromGround@Mob@@MEBAXAEAUIMobMovementProxy@@@Z
	/** jumpFromGround(void): void */
...
declare class NetworkItemStackDescriptor {
	...
	NetworkItemStackDescriptor(_1: object): NetworkItemStackDescriptor; /// ??0NetworkItemStackDescriptor@@QEAA@AEBV0@@Z
	// Inherited from ItemDescriptorCount
	/** serialize(BinaryStream &): void */
	serialize(_1: object): void; /// ?serialize@ItemDescriptorCount@@UEBAXAEAVBinaryStream@@@Z
	// Inherited from ItemDescriptor
...
declare class ResourceLocation {
	...
	ResourceLocation(_1: object): ResourceLocation; /// ??0ResourceLocation@@QEAA@AEBVPath@Core@@@Z
...
declare class SerializedSkin {
	...
	capeWidth: number;
	capeHeight: number;
	//	geometryData: Json::Value::Value;
	skinType: SDKText;
	isPersona: number;
	// Methods 
	// Inherited from SerializedSkin
	/** SerializedSkin(SerializedSkin const &) */
	SerializedSkin(_1: object): SerializedSkin; /// ??0SerializedSkin@@QEAA@AEBV0@@Z
	/** SerializedSkin(void) */
	...
	/** updateGeometryName(void): void */
	updateGeometryName(): void; /// ?updateGeometryName@SerializedSkin@@QEAAXXZ
	/** write(BinaryStream &): void */
	write(_1: object): void; /// ?write@SerializedSkin@@QEBAXAEAVBinaryStream@@@Z
	// Inherited from SDKText
}
...
declare class SynchedActorData {
	...
	/** setStatusFlag(ActorFlags,bool): void */
	setStatusFlag(_1: unknown, _2: boolean): void; /// ?setStatusFlag@SynchedActorData@@QEAAXW4ActorFlags@@_N@Z
	// Inherited from SDKVectorContainer
}
declare class SynchedActorDataEntityWrapper {
	...
	/** packDirty(void): class std::vector<class std::unique_ptr<class DataItem,struct std::default_delete<class DataItem> >,class std::allocator<class std::unique_ptr<class DataItem,struct std::default_delete<class DataItem> > > > */
	packDirty(): unknown; /// ?packDirty@SynchedActorDataEntityWrapper@@QEAA?AV?$vector@V?$unique_ptr@VDataItem@@U?$default_delete@VDataItem@@@std@@@std@@V?$allocator@V?$unique_ptr@VDataItem@@U?$default_delete@VDataItem@@@std@@@std@@@2@@std@@XZ
	/** setStatusFlag(ActorFlags,bool): void */
